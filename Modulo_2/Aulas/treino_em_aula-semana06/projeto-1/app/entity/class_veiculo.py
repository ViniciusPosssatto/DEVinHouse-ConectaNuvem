...
tipos_veiculos = {'carro': SaveLoadDatabase().load_database('carro'),
                  'moto': SaveLoadDatabase().load_database('motosTriciclos'),
                  'camionete': SaveLoadDatabase().load_database('camionetes')}
    ...
    def vender_veiculo(opcao, chassi, cpf, valor):
        ...
        for item in tipos_veiculos.get(opcao):
            if chassi == item['chassi']:
                ...
                SaveLoadDatabase().remove_data(opcao, chassi)
